...
export const aboutMeData: Record<Languages, AboutMeData> = {
  [Languages.RU]: {
    par1: `Готовый к работе специалист с опытом разработки приложений и сайтов на React и Next.js. Принимал участие в создании новых 
    проектов и в поддержке уже существующих. Имею уверенное техническое образование и аналитический склад ума. Хорошо работаю с документацией 
